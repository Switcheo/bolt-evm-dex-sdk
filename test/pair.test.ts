import { ChainId, Token, Pair, TokenAmount, WETH, Price, computePairAddress, INIT_CODE_HASH, FACTORY_ADDRESS } from '../src'
...
describe('Pair', () => {
  ...
  const pairAddress = computePairAddress(pairAddressData)
  ...
  describe('#getAddress', () => {
    it('returns the correct address', () => {
      expect(Pair.getAddress(USDC, DAI)).toEqual(pairAddress)
    })
  })
